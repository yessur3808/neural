...
public class QpsException extends RuntimeException {
    ...
    public QpsException(int code) {
        super();
        this.code = code;
    }

    public QpsException(int code, String message, Throwable cause) {
        super(message, cause);
        this.code = code;
    }

    public QpsException(int code, String message) {
        super(message);
        this.code = code;
    }

    public QpsException(int code, Throwable cause) {
        super(cause);
        this.code = code;
    }
